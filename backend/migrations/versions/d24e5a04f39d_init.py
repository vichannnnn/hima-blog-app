...
Revision ID: d24e5a04f39d
Revises: 
Create Date: 2023-04-22 07:19:04.198173
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("email", "subdomain", name="_email_subdomain_uc"),
        sa.UniqueConstraint("subdomain"),
        sa.UniqueConstraint("username"),
        sa.UniqueConstraint("username", "subdomain", name="_username_subdomain_uc"),
    )
    ...
    op.create_table(
        ...
        sa.Column("favicon", sa.String(), nullable=False),
